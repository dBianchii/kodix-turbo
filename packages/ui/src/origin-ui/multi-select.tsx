...
const MultipleSelector = ({
  ...
  return (
    <Command
      ...
      shouldFilter={commandProps?.shouldFilter === undefined || commandProps?.shouldFilter === null ? !onSearch : commandProps.shouldFilter} // When onSearch is provided, we don&lsquo;t want to filter the options. You can still override it.
        ...
        <div className="flex flex-wrap gap-1">
          ...
          <button
            ...
            className={cn(
              ...
              (hideClearAllButton ||
                (disabled === true || selected.length < 1) ||
