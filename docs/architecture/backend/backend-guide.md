...
Este guia detalha como implementar novas tabelas, relacionamentos, repositórios e APIs no backend do projeto Kodix. Para implementação de interfaces, consulte o <!-- AI-LINK: type="related" importance="medium" -->
...
> ⚠️ **IMPORTANTE**: Para comunicação entre SubApps, use **Service Layer** em vez de endpoints HTTP. Consulte <!-- AI-LINK: type="dependency" importance="high" -->
...
<!-- /AI-CONTEXT-REF -->
<!-- /AI-LINK --> para padrões de comunicação cross-app.
...
1. **Implement Frontend**: Consulte <!-- AI-LINK: type="related" importance="medium" -->
   <!-- AI-CONTEXT-REF: importance="medium" type="guide" -->
   [Frontend Development Guide](./../../../architecture/frontend/frontend-guide.md)
   <!-- /AI-CONTEXT-REF -->
   <!-- /AI-LINK -->
...
> 📚 **Referência Completa**: Para padrões completos de Service Layer, consulte <!-- AI-LINK: type="dependency" importance="high" -->
