...
export function ModelSelectorV3({
  selectedModelId,
  onModelSelect,
  disabled = false,
  variant = "default",
}: ModelSelectorV3Props) {
  ...
  const minWidth = variant === "compact" ? "min-w-[160px]" : "min-w-[200px]";
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className={cn(minWidth, "justify-between")}
          ...
          <div className="flex items-center gap-2">
            ...
            {isLoading ? (
              ...
              <div className="flex items-center gap-2">
                ...
                {selectedModel.provider && variant === "default" && (
