...
type SystemModelsQueryOutput =
  inferRouterOutputs<AppRouter>["app"]["aiStudio"]["findModels"];
type Model = SystemModelsQueryOutput[number];
...
export function ModelsSection() {
  ...
  const systemModels = (systemModelsQuery.data || []).sort(
    (a: Model, b: Model) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button className="ml-4" onClick={() => setShowCreateForm(true)}>
                ...
                {systemModels.map((model: Model) => (
                  <TableRow key={model.modelId}>
                    ...
                    <TableCell className="w-[100px]">
                      {/* Switch de Habilitado/Desabilitado */}
                      <Switch
